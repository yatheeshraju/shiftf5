...
function TermsAndConditions() {
  return (
    <div className="bg-white  p-14 flex flex-col w-full gap-2 h-screen/2">
      ...
      <ul>
        ...
        <li>
          <p>
            Website refers to Shift F5, accessible from{" "}
            <a
              href="shiftf5.dev"
      ...
      <p>
        If You have any concern or dispute about the Service, You agree to try
