...
function Intro({ handleShowPersonal }) {
  return (
    <div className="relative z-20 flex items-center overflow-hidden  dark:bg-zinc-800">
        ...
        <div className="relative z-20 flex flex-col sm:w-2/3 lg:w-2/5">
          ...
          <div className="flex mt-8">
            ...
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="px-4 py-2 text-teal-500 uppercase bg-transparent border-2 border-teal-500 rounded-lg dark:text-white hover:bg-teal-500 hover:text-white text-md"
            >
              ENTERPRISE
            </a>
          </div>
